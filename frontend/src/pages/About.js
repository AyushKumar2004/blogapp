  ...
  return (
    <div className="container mx-auto my-12 p-4 space-y-9">
      ...
      <p>
        ...
        dynamic, responsive, and user-friendly web applications, Ayush excels in
      ...
      <br />
      <span>
        Ayush kumar is dedicated to leveraging his expertise to contribute to
      ...
      <p>
        Beyond his professional achievements, Ayush is a big fan of Footbal and
        holds immense admiration for <strong> Lionel Messi.</strong> His favorite
        person and biggest inspiration is his twin brother,{" "}
        <strong>Yuvraj.</strong> Their friendly rivalry and deep bond have
        significantly shaped ayush’s journey. yuvraj is not only a great
